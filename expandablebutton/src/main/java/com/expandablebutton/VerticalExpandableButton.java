...
public class VerticalExpandableButton extends FrameLayout {
    ...
    public VerticalExpandableButton(Context context) {
        super(context);
        initView(context);
    }

    public VerticalExpandableButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void attachButtonListener() {
        this.button.setOnClickListener(v -> {
            ...
            ExpandableFactory.getDilatableView("Vertical").dilateWith(v);
        });
    }
}